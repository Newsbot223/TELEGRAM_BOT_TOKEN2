...
module.exports = {
  ...
  from: {
    ...
    /* .com to match the domain reservation.js already sends from
       (reservierung@takashi-restaurant.com) — same verified domain,
       different mailbox for order vs. reservation mail. */
    address: process.env.EMAIL_FROM_ADDRESS || 'orders@takashi-restaurant.com'
  },
